        ...
        <main>
            <section class="section-about">
                ...
                <div class="row">
                    <div class="col-1-of-2">
                        <h3 class="heading-tertiary u-margin-bottom-small">You're going to fall in love with the outside world</h3>
                        <p class="paragraph">
                        </p>
                        <h3 class="heading-tertiary u-margin-bottom-small">Experience you never have before</h3>
                        <p class="paragraph">
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-1-of-4">
                        <div class="feature-box">
                            ...
                            <h3 class="heading-tertiary u-margin-bottom-small">Find unique way</h3>
                            <p class="feature-box__text">
                    ...
                    <div class="col-1-of-4">
                        <div class="feature-box">
                            ...
                            <h3 class="heading-tertiary u-margin-bottom-small">Working in group</h3>
                             <p class="feature-box__text">
                    ...
                    <div class="col-1-of-4">
                        <div class="feature-box">
                            ...
                            <h3 class="heading-tertiary u-margin-bottom-small">Be Healthier</h3>
                            <p class="feature-box__text">
            ...
            <section class="section-stories">
                ...
                <div class="row">
                    <div class="story">
                        <figure class="story__shape">
                            ...
                            <figcaption class="story__caption">IU</figcaption>
                        </figure>
                        <div class="story__text">
                            <h3 class="heading-tertiary u-margin-bottom-small">I had the best week ever with my family</h3>
                            <p>
                                The sun shines, the beach is beautiful there. And the food was super delicious!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="story">
                        <figure class="story__shape">
                            <img src="img/nat-9.png" alt="Person on a tour" class="story__img">
                            <figcaption class="story__caption">Jack Sparrow</figcaption>
                        </figure>
                        <div class="story__text">
                            <h3 class="heading-tertiary u-margin-bottom-small">WOW! My life is completely different now</h3>
                            <p>
                                I could swing rope, walk on the snow and of course, doing very hard things.
                            </p>
                        </div>
                    </div>
                </div>
